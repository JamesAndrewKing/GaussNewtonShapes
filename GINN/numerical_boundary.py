...
def find_boundary_points_numerically_with_binsearch(x_grid, x_grid_dist, level_set, netp: NetWithPartials, z, n_steps=5, resolution=None, nf_is_density=False, verbose=False):
    '''
